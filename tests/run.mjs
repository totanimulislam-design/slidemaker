...
const suites = [
  ...
  ["title background (the plate behind the heading: preset groups incl. the stylish · multilayer · multilayer-gradient shape styles · 92 silhouettes in thirteen groups — the shape library (Basic & Clean · Banner Style · Cut & Corner · Modern · Curved & Wave · Organic / Decorative · Decorative / Highlight · Premium / Special) plus the original paint families · effects · fill · ONE border card: colour through the shared colour card · style · weight · transparency · radius for all corners or each corner · glow · the shape's transparency · free size · free position · show/hide · default)", "banner.test.tsx", "runBannerTests"],
  ["banner effects (the plate's Effects card, in categories: shadow on X · Y · Blur · Spread · Opacity · Colour · glow on Type · Blur · Intensity · Colour · blur · glass · bevel on Depth · Blur · Angle · 3D · highlight · decorations · finishes · shape effects — one per category, the shape's distortions stacked, every tile a miniature of the plate, every effect colour auto to the shape's own paint, and decks written before the categories folded into the right one)", "bannereffects.test.tsx", "runBannerFxTests"],
