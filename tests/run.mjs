...
const suites = [
  ...
  ["banner effects (the plate's Effects card: common effects — the text background's own effects · shadow effects on X · Y · Blur · Spread · Opacity · Colour · glow & light · depth / 3D · modern effects · shape effects · decorative effects — one per group, the shape's distortions stacked)", "bannereffects.test.tsx", "runBannerFxTests"],
