...
const suites = [
  ...
  ["title background (the plate behind the heading: presets · shape · effects · fill · border colour/style/radius/weight · transparency · free size · free position · show/hide · default)", "banner.test.tsx", "runBannerTests"],
